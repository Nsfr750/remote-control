...
- [x] Multi-platform support
  ...
  - [ ] macOS (planned)
- [x] **Nuitka Compilation**: Standalone executables
...
- [x] **Mouse Control**: Fixed Linux mouse click handling
...
- [ ] Performance improvements
  - [x] Screen compression (implemented)
  - [ ] Reduced latency for input handling
  - [x] Optimized network protocol
